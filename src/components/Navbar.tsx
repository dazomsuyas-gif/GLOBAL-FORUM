...
const Navbar: React.FC<{}> = () => {
    ...
    const navLinks = [
        ...
        { name: 'Politics & History', href: '/politics-history' },
        { name: 'Econ/Edu/RE', href: '/economics-education-realestate' },
        { name: 'Sports/Ent/Health', href: '/sports-entertainment-health' },
        { name: 'Tech & Science', href: '/technology-science' },
